...
<form action="request/web/login.php" method="post">
        ...
        <div class="col-sm-12 col-lg-12 col-md-12 col-xs-12" style="margin-top: 3%">
            <input type="text" name="password" placeholder="رمز عبور" class="form-control " style="text-align: center">
            <input type="text" name="username" value="<?php echo $_GET['username']?>" placeholder="رمز عبور" class="form-control " style="text-align: center;display: none">
            <?php if($_GET['username']==""){
                header('location:sign-in.php');
            } ?>
            <i class="fas fa-lock iconlogin"></i>
        </div>
        ...
        <div class="col-sm-12 col-lg-12 col-md-12 col-xs-12" style="text-align: center;margin-top: 5%;margin-bottom: 5%">
            <a >
                <button type="submit" class="btn" style="background-color: #009900;color: white;width: 30%">ورود</button>
        ...
        <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12" style="background-color: #f9f9f9;margin-top: -8%;text-align: center;border-top: 1px solid #ebebeb">
